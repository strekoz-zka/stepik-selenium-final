...
class LoginPage(BasePage):
    def register_new_user(self, email, password):
        ...
        self.browser.find_element(*LoginPageLocators.PASSWORD_REGISTER_CONFIRM).send_keys(password)
    ...
    def should_be_login_url(self):
        assert LoginPageLocators.LINK_CONTAINS in self.browser.current_url
