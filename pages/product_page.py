...
class ProductPage(MainPage):
    ...
    def should_be_item_name_in_add_to_cart_message(self):
        ...
        assert item_name in add_to_cart_msg, 'Add to cart message does not contain the item name'
    ...
    def should_be_correct_cart_sum(self):
        ...
        assert item_cost in cart_cost_msg, 'Add to cart message does not contain correct item cost'
